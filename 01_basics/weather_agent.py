...
#         #handling if there is any tool call
#         if result.tool_calls:
#             tool_call = result.tool_calls[0]
#             function_name = tool_call.function.name
#             function_arguments = json.loads(tool_call.function.arguments)
...
#             parsed_response = {
#                 "step": "execute",
#                 "content": f"Calling {function_name} with {function_arguments}",
#                 "function": function_name,
#                 "input": function_arguments.get("city")
#             }
#         else:
#             try:
#                 parsed_response = json.loads(result.content)
...
#                 parsed_response = json.loads(re.sub(r"```json|```", "", result.content))
...
#                 output = names_to_functions.get(tool_name)(tool_input)
#                 messages.append(
#                     {
#                         "role": "assitant",
